...
//********************************************************************************
{
...

  {
    ...
    Parallel::For (nPart, [this, &particlePos, dh](size_t iPart){ 
...

  {
    ...
    Parallel::For (nPart, [this, &particlePos, &particleNei, makeRange, h2](size_t iPart){ 
...

  {
    ...
    Parallel::For (nPart, [ &particleNei, comp ](size_t iPart){ 
